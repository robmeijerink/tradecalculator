        ...
        <form>
            ...
            <div class="flex items-center mb-10">
                ...
                <div class="flex-1 flex items-center">
                    <input v-model.number="input.risk" @keydown.space.prevent="onlyNumeric" type="number" min="0" max="100" step="0.05" id="risk" name="risk" class="py-2 border-b-2 border-gray-400 text-gray-600 placeholder-gray-400 mr-4" placeholder="Recommended: 1%">
